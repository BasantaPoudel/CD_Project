...
def data_dimensionality(filename, dataset, index_col, target):
    ...
    plot_series(data, x_label='timestamp', y_label='consumption', title='drought')
    xticks(rotation=45)
...
data_dimensionality('data/forecasting/drought.forecasting_dataset.csv', 'dataset2', 'date', 'QV2M')
