...
data_distribution('forecasting/data/classification/diabetic_data.csv', 'dataset1', "encounter_id", "?", 'readmitted')
data_distribution('forecasting/data/classification/drought.csv', 'dataset2', 'date', '', 'class')
