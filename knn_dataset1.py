...
file_tag = 'diabetes_nobalance_zscore'

def plot_overfitting_study(xvalues, prd_trn, prd_tst, name, xlabel, ylabel):
    evals = {'Train': prd_trn, 'Test': prd_tst}
    figure()
    multiple_line_chart(xvalues, evals, ax = None, title=f'Overfitting {name}', xlabel=xlabel, ylabel=ylabel, percentage=True)
    savefig('images/knn/dataset1/'+file_tag+'_overfitting_'+name+'.png')


filenametrain = f'data/classification/datasets_for_further_analysis/dataset1/zscore_diabetes_train.csv' #diatebes_minmax_balanced_under.csv'
...
savefig('images/knn/dataset1/'+file_tag+'_overfitting_knn_study.png')
show()
