...
def random_forest(filename, file, dataset, clas):
    ...
    n_estimators = [5, 10, 25, 75, 200, 400]
    max_depths = [5, 10, 25]
    ...
    savefig('images/random_forest/' + dataset + '/overfit_study.png')


# random_forest('forecasting/data/classification/data_for_DT_RF/minmax_diabetes',
#              'dataset1', 'dataset1', 'readmitted')

random_forest('data/classification/datasets_for_further_analysis/dataset2/dataset2_feature_engineering',
