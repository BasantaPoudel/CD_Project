...
file = 'diabetic'
filename = 'forecasting/data/classification/diabetic_data.csv'
...
filename = f'forecasting/data/classification/datasets_for_further_analysis/dataset1/{file}_drop_columns_mv.csv'
data = read_csv(filename, index_col='encounter_id', na_values='?', parse_dates=True, infer_datetime_format=True)
