...
filename = 'data/classification/datasets_for_further_analysis/dataset1/minmax_diabetes_train.csv'
...
savefig(f'images/data_balancing/dataset1/diabetes_resumen_unbalance.png')
show()
...
savefig(f'images/data_balancing/dataset1/diabetes_resumen_balance.png')
show()
